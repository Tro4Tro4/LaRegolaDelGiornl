...
SOCIALE = [
 ("Oggi ringrazia qualcuno per una cosa che ha fatto più di un anno fa.", Q, 2, None, None),
 ...
 ("Oggi fai tu il primo passo con chi stavi per evitare.", Q, 3, None, None),
 ("Oggi chiedi a qualcuno che lavoro facevano i suoi genitori.", Q, 2, None, None),
 ...
 ("Oggi di' di no a una cosa che avresti accettato per inerzia.", Q, 3, None, None),
 ("Oggi chiedi scusa per una cosa piccola che nessuno ha notato.", Q, 2, None, None),
 ("Oggi mangia in compagnia, non per conto tuo.", Q, 1, None, None),
 ...
 ("Oggi di' a qualcuno una cosa che apprezzi e non hai mai detto.", Q, 3, None, None),
...
FISICO = [
 ...
 ("Oggi allunga di dieci minuti la strada verso casa.", Q, 1, A, 1000),
 ...
 ("Oggi stiracchiati ogni volta che ti accorgi di non muoverti da un po'.", Q, 1, None, None),
 ...
 ("Oggi raddoppia i passi che fai di solito.", Q, 3, P, 100),
...
DIGITALE = [
 ...
 ("Oggi rispondi a un messaggio solo quando puoi dedicargli attenzione.", Q, 2, None, None),
 ...
 ("Oggi spegni il telefono per un'ora, e avvisa prima qualcuno.", Q, 3, None, None),
 ...
 ("Oggi non mettere segni di approvazione a nessuno.", Q, 2, None, None),
...
CREATIVO = [
 ...
 ("Oggi fotografa una cosa sola, e nient'altro.", Q, 2, None, None),
 ("Oggi disegna male un oggetto che hai davanti.", Q, 1, None, None),
 ...
 ("Oggi canta qualcosa ad alta voce, senza nessuno intorno.", Q, 2, None, None),
 ...
 ("Oggi prova una ricetta di un posto che non hai mai visitato.", FS, 2, None, None),
 ("Oggi disegna la pianta della casa della tua infanzia.", Q, 2, None, None),
...
INTROSPETTIVO = [
 ...
 ("Oggi resta dieci minuti senza fare niente.", Q, 2, None, None),
 ...
 ("Oggi chiediti, una volta, se quello che stai facendo lo fai per te.", Q, 3, None, None),
 ...
 ("Oggi nota la prima cosa che ti fa sorridere.", Q, 1, None, None),
 ...
 ("Oggi chiediti chi ti manca, senza andare oltre.", Q, 3, None, None),
 ("Oggi nota quante decisioni prendi prima delle nove.", Q, 1, None, None),
 ("Oggi ritarda di dieci minuti il sonno, al buio, senza schermi.", Q, 2, None, None),
